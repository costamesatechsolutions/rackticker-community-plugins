...
You are editing one RackTicker plugin: this folder within the community repository. Do not edit RackTicker itself.

This plugin follows the CMTS rackticker-plugin-starter format. Its entry file is
named in plugin.json. Keep it independently installable from this folder.
